...
export const Auth = () => {
  return (
    <div className="min-h-screen bg-gradient-to-r from-blue-500 to-purple-600 flex items-center justify-center">
      <div className="flex space-x-12 p-6 bg-white rounded-lg shadow-xl w-full max-w-4xl border-4 border-red-800">
        {/* Login Form */}
        <Login />
        {/* Register Form */}
        <Register />
...
const Login = () => {
  ...
  const handleSubmit = async (event) => {
    ...
    try {
      const result = await axios.post("https://localhost:3000/auth/login", {
        username,
        password,
      });
